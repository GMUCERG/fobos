...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "TEST_CAPTURE" -parent ${Page_0}
...
proc update_PARAM_VALUE.TEST_CAPTURE { PARAM_VALUE.TEST_CAPTURE } {
	# Procedure called to update TEST_CAPTURE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TEST_CAPTURE { PARAM_VALUE.TEST_CAPTURE } {
	# Procedure called to validate TEST_CAPTURE
	return true
}
...
proc update_MODELPARAM_VALUE.TEST_CAPTURE { MODELPARAM_VALUE.TEST_CAPTURE PARAM_VALUE.TEST_CAPTURE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TEST_CAPTURE}] ${MODELPARAM_VALUE.TEST_CAPTURE}
}
