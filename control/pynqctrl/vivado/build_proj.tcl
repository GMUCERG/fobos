...
#
# pynq_controller.tcl: Tcl script for re-creating project 'pynq_controller'
#
# Generated by Vivado on Mon Jun 05 18:19:01 EDT 2023
...
set _xil_proj_name_ "pynq_controller"
...
set script_file "pynq_controller.tcl"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ctrl_top_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/src/constr/pynq_z1_rev2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constr/pynq_z1_rev2.xdc"
...
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constr/pynq_z1_rev1.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "0" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/src/constr/pynq_z2_rev1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constr/pynq_z2_rev1.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "0" -objects $file_obj
...
#set files [list \
# [file normalize "${origin_dir}/pynq_controller/pynq_controller.srcs/utils_1/imports/synth_1/ctrl_top_wrapper.dcp" ]\
#]
...
#set file "synth_1/ctrl_top_wrapper.dcp"
...
set obj [get_runs synth_1]
set_property -name "part" -value "xc7z020clg400-1" -objects $obj
#set_property -name "incremental_checkpoint" -value "$proj_dir/pynq_controller.srcs/utils_1/imports/synth_1/ctrl_top_wrapper.dcp" -objects $obj
