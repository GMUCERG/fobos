...
architecture STRUCTURE of ctrl_top_wrapper is
  ...
  ---REMOVED FROM entity ports for old shield
 
  signal gain_3v3 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal gain_5v : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal gain_var : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal fc_prog : STD_LOGIC;
  signal glitch : STD_LOGIC;
  signal glitch_lp : STD_LOGIC;
