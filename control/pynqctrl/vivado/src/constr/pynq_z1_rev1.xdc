...
#   Description:                                                            #
#   Constraint file for FOBOS Shield revision 1.0 on PYNQ-Z1 board          #
#                                                                           #
#   Copyright 2023 CERG                                                     #
#                                                                           #
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { fc_rst }]; #IO_L5P_T0_34 Sch=ck_io[0]
...
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { fc_prog }]; #IO_L5N_T0_34 Sch=ck_io[5]
...
set_property -dict {PACKAGE_PIN C20 IOSTANDARD LVCMOS33} [get_ports {gain_var[1]}]
set_property -dict {PACKAGE_PIN F20 IOSTANDARD LVCMOS33} [get_ports {gain_3v3[0]}]
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS33} [get_ports {gain_3v3[1]}]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS33} [get_ports trigger_osc]
set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { gain_5v[1] }]; #IO_L2P_T0_AD8P_35 Sch=ad_p[8]

##ChipKit Digital I/O High

set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { fc_io }]; #IO_L19N_T3_VREF_13 Sch=ck_io[26]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { fd_tf }]; #IO_L6N_T0_VREF_13 Sch=ck_io[27]
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { fc2d_hs }]; #IO_L22P_T3_13 Sch=ck_io[28]
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { fd2c_clk }]; #IO_L11P_T1_SRCC_13 Sch=ck_io[29]
...
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { glitch }]; #IO_L10N_T1_34 Sch=ck_miso
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { adc_gain }]; #IO_L2P_T0_34 Sch=ck_mosi
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { glitch_lp }]; #IO_L19P_T3_35 Sch=ck_sck
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { adc_gain_mode }]; #IO_L6P_T0_35 Sch=ck_ss

## ChipKit I2C

set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { gain_5v[0] }]; #IO_L24N_T3_34 Sch=ck_scl
