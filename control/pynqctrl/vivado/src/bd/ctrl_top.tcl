...
user.org:user:openadc_interface_light:1.0\
CERG:cerg:powermanager:1.1\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:processing_system7:5.5\
CERG:cerg:user_led:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set adc [ create_bd_port -dir I -from 9 -to 0 adc ]
  set adc_clk [ create_bd_port -dir O -type clk adc_clk ]
  set adc_gain [ create_bd_port -dir O adc_gain ]
  set adc_gain_mode [ create_bd_port -dir O adc_gain_mode ]
  set adc_or [ create_bd_port -dir I adc_or ]
  set ck_an_n [ create_bd_port -dir I -from 5 -to 0 ck_an_n ]
  set ck_an_p [ create_bd_port -dir I -from 5 -to 0 ck_an_p ]
  ...
  set dio_I [ create_bd_port -dir I -from 3 -to 0 -type data dio_I ]
  set dio_O [ create_bd_port -dir O -from 3 -to 0 -type data dio_O ]
  set dio_T [ create_bd_port -dir O -from 3 -to 0 dio_T ]
  ...
  set fc2d_clk [ create_bd_port -dir O -from 0 -to 0 -type clk fc2d_clk ]
  set fc2d_hs [ create_bd_port -dir O fc2d_hs ]
  ...
  set gain_5v [ create_bd_port -dir O -from 1 -to 0 gain_5v ]
  set gain_var [ create_bd_port -dir O -from 1 -to 0 gain_var ]
  set glitch [ create_bd_port -dir O glitch ]
  set glitch_lp [ create_bd_port -dir O glitch_lp ]
  ...
  set pwr_O [ create_bd_port -dir O -from 5 -to 0 -type data pwr_O ]
  set pwr_T [ create_bd_port -dir O -from 5 -to 0 pwr_T ]
  set trigger_osc [ create_bd_port -dir O trigger_osc ]
  ...
  # Create instance: openadc_interface_li_1, and set properties
  set openadc_interface_li_1 [ create_bd_cell -type ip -vlnv user.org:user:openadc_interface_light:1.0 openadc_interface_li_1 ]
...
unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned} \
  ...
  set user_led_0 [ create_bd_cell -type ip -vlnv CERG:cerg:user_led:1.0 user_led_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_S2MM [get_bd_intf_pins axi_dma_1/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S02_AXI]
  ...
  connect_bd_intf_net -intf_net openadc_interface_li_1_M_BLKS_AXIS [get_bd_intf_pins axis_data_fifo_2/S_AXIS] [get_bd_intf_pins openadc_interface_li_1/M_BLKS_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins openadc_interface_li_1/S_CFG_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins clk_wiz_adc/s_axi_lite] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins axi_uart16550_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins ps7_0_axi_periph/M10_AXI] [get_bd_intf_pins user_led_0/S00_AXI]

  # Create port connections
  connect_bd_net -net adc_in_1 [get_bd_ports adc] [get_bd_pins openadc_interface_li_1/adc_in]
  connect_bd_net -net adc_or_1 [get_bd_ports adc_or] [get_bd_pins openadc_interface_li_1/over_range]
  ...
  connect_bd_net -net axi_uart16550_0_sout [get_bd_pins axi_uart16550_0/sout] [get_bd_pins dutcomm_0/serial_tx]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axis_data_fifo_2/s_axis_aclk] [get_bd_pins clk_wiz_adc/clk_out1] [get_bd_pins openadc_interface_li_1/m_blks_axis_aclk] [get_bd_pins proc_sys_reset_adc/slowest_sync_clk]
  ...
  connect_bd_net -net dio_I_1 [get_bd_ports dio_I] [get_bd_pins dutcomm_0/dio_I]
  ...
  connect_bd_net -net dut_controller_0_en_serial [get_bd_pins dut_controller_0/en_serial] [get_bd_pins dutcomm_0/serial_en]
  ...
  connect_bd_net -net dut_controller_0_trigger_osc [get_bd_ports trigger_osc] [get_bd_pins dut_controller_0/trigger_osc]
  connect_bd_net -net dut_controller_0_trigger_out [get_bd_pins dut_controller_0/trigger_out] [get_bd_pins openadc_interface_li_1/trigger] [get_bd_pins powermanager_0/trigger] [get_bd_pins user_led_0/trigger]
  connect_bd_net -net dut_controller_0_wait_for_rst [get_bd_pins dut_controller_0/wait_for_rst] [get_bd_pins dutcomm_0/wait_for_rst]
  ...
  connect_bd_net -net dutcomm_0_dio_O [get_bd_ports dio_O] [get_bd_pins dutcomm_0/dio_O]
  connect_bd_net -net dutcomm_0_dio_T [get_bd_ports dio_T] [get_bd_pins dutcomm_0/dio_T]
  ...
  connect_bd_net -net dutcomm_0_handshake_c2d [get_bd_ports fc2d_hs] [get_bd_pins dutcomm_0/handshake_c2d]
  ...
  connect_bd_net -net dutcomm_0_serial_rx [get_bd_pins axi_uart16550_0/sin] [get_bd_pins dutcomm_0/serial_rx]
  ...
  connect_bd_net -net openadc_interface_li_1_adc_clk [get_bd_ports adc_clk] [get_bd_pins openadc_interface_li_1/adc_clk]
  connect_bd_net -net openadc_interface_li_1_gain [get_bd_ports adc_gain] [get_bd_pins openadc_interface_li_1/gain]
  connect_bd_net -net openadc_interface_li_1_gain_mode [get_bd_ports adc_gain_mode] [get_bd_pins openadc_interface_li_1/gain_mode]
  connect_bd_net -net power_ok_1 [get_bd_ports power_ok] [get_bd_pins powermanager_0/power_ok]
  connect_bd_net -net powermanager_0_gain_0 [get_bd_ports gain_3v3] [get_bd_pins powermanager_0/gain_0]
  connect_bd_net -net powermanager_0_gain_1 [get_bd_ports gain_5v] [get_bd_pins powermanager_0/gain_1]
  connect_bd_net -net powermanager_0_gain_2 [get_bd_ports gain_var] [get_bd_pins powermanager_0/gain_2]
  connect_bd_net -net powermanager_0_power_en [get_bd_ports power_en] [get_bd_pins powermanager_0/power_en]
  connect_bd_net -net powermanager_0_pwr_O [get_bd_ports pwr_O] [get_bd_pins powermanager_0/pwr_O]
  connect_bd_net -net powermanager_0_pwr_T [get_bd_ports pwr_T] [get_bd_pins powermanager_0/pwr_T]
  connect_bd_net -net proc_sys_reset_adc_peripheral_aresetn [get_bd_pins axis_data_fifo_2/s_axis_aresetn] [get_bd_pins openadc_interface_li_1/m_blks_axis_aresetn] [get_bd_pins proc_sys_reset_adc/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins axis_data_fifo_2/m_axis_aclk] [get_bd_pins clk_wiz/clk_in1] [get_bd_pins clk_wiz/s_axi_aclk] [get_bd_pins clk_wiz_adc/clk_in1] [get_bd_pins clk_wiz_adc/s_axi_aclk] [get_bd_pins openadc_interface_li_1/s_cfg_axi_aclk] [get_bd_pins powermanager_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/M11_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins user_led_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_adc/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins rst_ps7_0_1M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins clk_wiz/s_axi_aresetn] [get_bd_pins clk_wiz_adc/s_axi_aresetn] [get_bd_pins openadc_interface_li_1/s_cfg_axi_aresetn] [get_bd_pins powermanager_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/M11_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins user_led_0/s00_axi_aresetn]
  connect_bd_net -net rst_ps7_0_1M_interconnect_aresetn [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins rst_ps7_0_1M/interconnect_aresetn]
  ...
  connect_bd_net -net user_led_0_led [get_bd_ports led] [get_bd_pins user_led_0/led]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports dut_clk] [get_bd_ports fc2d_clk] [get_bd_pins util_vector_logic_0/Res]
  ...
  assign_bd_address -offset 0x43C60000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs clk_wiz/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x43C50000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs clk_wiz_adc/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dut_controller_0/S_AXI/S_AXI_reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dutcomm_0/S_AXI/S_AXI_reg] -force
  assign_bd_address -offset 0x43C40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs openadc_interface_li_1/S_CFG_AXI/S_CFG_AXI_reg] -force
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs powermanager_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C70000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs user_led_0/S00_AXI/S00_AXI_reg] -force
